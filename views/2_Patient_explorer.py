...
ui.page(
    "Patient explorer",
    f"Replay a recorded day and watch what the model said {HORIZON_MINUTES} minutes "
    "before it happened. Every wearer here is from the held-out test split, so this "
    "is the model meeting someone it has never seen.",
    pills=["held-out wearers", "retrospective replay"],
)
